...
아래 예시는 고정 시드 `20260911`로 1개 장면, 5개 주행 구간, 500개 소나 신호를 취득한 결과입니다. 전체 예시는 [`examples/sample_dataset`](examples/sample_dataset)에 있습니다.
...
- 이 예시는 `RTX 5060 Ti 16 GB`에서 약 27초가 걸렸습니다. 장면과 설정에 따라 시간은 크게 달라집니다.
